  ...
  _ = function (a, v, d) {
    ...
    if (v && v.length > 0) {
      ...
      const y = document.querySelector('meta[property=csp-nonce]'),
        F = (y == null ? void 0 : y.nonce) || (y == null ? void 0 : y.getAttribute('nonce'));
      i = Promise.allSettled(
        v.map((r) => {
          if (((r = Ee(r)), r in se)) return;
          se[r] = !0;
          ...
          if (
            ...
            return new Promise((P, j) => {
              (u.addEventListener('load', P),
                u.addEventListener('error', () => j(new Error(`Unable to preload CSS for ${r}`))));
            });
        }),
      );
    }
    function g(y) {
      ...
      if (((F.payload = y), window.dispatchEvent(F), !F.defaultPrevented)) throw y;
    }
    return i.then((y) => {
      for (const F of y || []) F.status === 'rejected' && g(F.reason);
      return a().catch(g);
    });
  },
  Ie = (w, a, v) => {
...
(function w(a, v, d, i) {
  var g = !!(
      ...
      a.HTMLCanvasElement &&
      a.HTMLCanvasElement.prototype.transferControlToOffscreen &&
      a.URL &&
      a.URL.createObjectURL
    ),
    y = typeof Path2D == 'function' && typeof DOMMatrix == 'function',
    F = (function () {
      if (!a.OffscreenCanvas) return !1;
      try {
        var t = new OffscreenCanvas(1, 1),
          e = t.getContext('2d');
        e.fillRect(0, 0, 1, 1);
        var o = t.transferToImageBitmap();
        e.createPattern(o, 'no-repeat');
      } catch {
        return !1;
      }
      return !0;
  ...
  function s(t) {
    var e = v.exports.Promise,
      o = e !== void 0 ? e : a.Promise;
    return typeof o == 'function' ? new o(t) : (t(r, r), null);
  }
  var p = (function (t, e) {
      return {
        transform: function (o) {
          ...
          var c = new OffscreenCanvas(o.width, o.height),
            l = c.getContext('2d');
          return (l.drawImage(o, 0, 0), e.set(o, c), c);
        },
        clear: function () {
          e.clear();
        },
            ...
            return (
              (e = s(function (I) {
                ...
                (l.addEventListener('message', C),
                  m(n, x),
                  (o[x] = C.bind(null, { data: { callback: x } })));
              })),
              e
            );
          }),
      ...
      return function () {
        ...
        if (!d && g) {
          var l = [
            ...
            '(' + w.toString() + ')(this, module, true, SIZE);',
...
`);
  ...
  function L(t) {
    ...
    return (
      ...
      { r: A(e.substring(0, 2)), g: A(e.substring(2, 4)), b: A(e.substring(4, 6)) }
    );
  }
  function z(t) {
  ...
  function ie(t, e, o, c, l, m, f, n, h) {
    (t.save(), t.translate(e, o), t.rotate(m), t.scale(c, l), t.arc(0, 0, 1, f, n, h), t.restore());
  }
  function ce(t) {
    var e = t.angle * (Math.PI / 180),
      o = t.spread * (Math.PI / 180);
    return {
      x: t.x,
      y: t.y,
  ...
  function le(t, e) {
    ...
    if (
      ((t.fillStyle =
        'rgba(' + e.color.r + ', ' + e.color.g + ', ' + e.color.b + ', ' + (1 - o) + ')'),
      t.beginPath(),
      y &&
        e.shape.type === 'path' &&
      ...
      (k.setTransform(C),
        (t.globalAlpha = 1 - o),
        (t.fillStyle = k),
        t.fillRect(e.x - x / 2, e.y - I / 2, x, I),
        (t.globalAlpha = 1));
      ...
      M = s(function (x) {
        ...
        function C() {
          (d &&
            ...
            !c.width && !c.height && (o(t), (c.width = t.width), (c.height = t.height)),
            f.clearRect(0, 0, c.width, c.height),
            (m = m.filter(function (k) {
              return le(f, k);
            })),
            m.length ? (n = u.frame(C)) : I());
        }
        ((n = u.frame(C)), (h = I));
      });
    return {
      addFettis: function (x) {
        return ((m = m.concat(x)), M);
      },
      canvas: t,
      promise: M,
      reset: function () {
  ...
  function K(t, e) {
    var o = !t,
      c = !!E(e || {}, 'resize'),
      l = !1,
      m = E(e, 'disableForReducedMotion', Boolean),
      f = g && !!E(e || {}, 'useWorker'),
      n = f ? P() : null,
      h = o ? U : X,
      M = t && n ? !!t.__confetti_initialized : !1,
      x = typeof matchMedia == 'function' && matchMedia('(prefers-reduced-motion)').matches,
      I;
    function C(b, S, O) {
      for (
        var q = E(b, 'particleCount', T),
          V = E(b, 'angle', Number),
          G = E(b, 'spread', Number),
          W = E(b, 'startVelocity', Number),
          fe = E(b, 'decay', Number),
          he = E(b, 'gravity', Number),
          ve = E(b, 'drift', Number),
          te = E(b, 'colors', H),
          ge = E(b, 'ticks', Number),
          re = E(b, 'shapes'),
        ...
        J.push(
          ce({
            ...
            spread: G,
            startVelocity: W,
            color: te[ae % te.length],
            shape: re[R(0, re.length)],
            ticks: ge,
            decay: fe,
            gravity: he,
            drift: ve,
      ...
      return I ? I.addFettis(J) : ((I = de(t, J, h, S, O)), I.promise);
    }
    function k(b) {
      var S = m || E(b, 'disableForReducedMotion', Boolean),
        O = E(b, 'zIndex', Number);
      if (S && x)
        return s(function (W) {
          W();
        });
      (o && I ? (t = I.canvas) : o && !t && ((t = ne(O)), document.body.appendChild(t)),
        c && !M && h(t));
      var q = { width: t.width, height: t.height };
      (n && !M && n.init(t), (M = !0), n && (t.__confetti_initialized = !0));
      function V() {
        if (n) {
          var W = {
          ...
          (h(W), n.postMessage({ resize: { width: W.width, height: W.height } }));
          return;
        }
      ...
      function G() {
        ((I = null),
          c && ((l = !1), a.removeEventListener('resize', V)),
          o &&
            t &&
            (document.body.contains(t) && document.body.removeChild(t), (t = null), (M = !1)));
      }
      return (
        c && !l && ((l = !0), a.addEventListener('resize', V, !1)),
        n ? n.fire(b, q, G) : C(b, q, G)
      );
    }
    return (
      (k.reset = function () {
  ...
  var Y;
  function ee() {
    return (Y || (Y = K(null, { useWorker: !0, resize: !0 })), Y);
  }
  function ue(t, e, o, c, l, m, f) {
    var n = new Path2D(t),
      h = new Path2D();
    ...
    return (
      M.addPath(
        h,
        new DOMMatrix([Math.cos(f) * l, Math.sin(f) * l, -Math.sin(f) * m, Math.cos(f) * m, o, c]),
      ),
      M
    );
  }
  function me(t) {
    ...
    var e, o;
    typeof t == 'string' ? (e = t) : ((e = t.path), (o = t.matrix));
    var c = new Path2D(e),
      l = document.createElement('canvas'),
      m = l.getContext('2d');
    if (!o) {
      for (var f = 1e3, n = f, h = f, M = 0, x = 0, I, C, k = 0; k < f; k += 2)
        for (var b = 0; b < f; b += 2)
          m.isPointInPath(c, k, b, 'nonzero') &&
            ((n = Math.min(n, k)),
            (h = Math.min(h, b)),
            (M = Math.max(M, k)),
            (x = Math.max(x, b)));
      ...
      var S = 10,
        O = Math.min(S / I, S / C);
      o = [O, 0, 0, O, -Math.round(I / 2 + n) * O, -Math.round(C / 2 + h) * O];
    }
    return { type: 'path', path: e, matrix: o };
  }
  function pe(t) {
    var e,
      o = 1,
    ...
    var m = 10 * o,
      ...
      h = n.getContext('2d');
    h.font = f;
    var M = h.measureText(e),
      x = Math.ceil(M.actualBoundingBoxRight + M.actualBoundingBoxLeft),
      I = Math.ceil(M.actualBoundingBoxAscent + M.actualBoundingBoxDescent),
      C = 2,
      k = M.actualBoundingBoxLeft + C,
      b = M.actualBoundingBoxAscent + C;
    ((x += C + C),
      (I += C + C),
      (n = new OffscreenCanvas(x, I)),
      (h = n.getContext('2d')),
      (h.font = f),
      (h.fillStyle = c),
      h.fillText(e, k, b));
...
(function () {
  ...
  function a(r) {
    ...
    const u = document.getElementById('tool-search'),
      j = document.getElementById('tools-grid').querySelectorAll('.tool-card'),
      D = () => {
        const T = u.value.toLowerCase(),
          R = document.querySelector('.category-tab.active').getAttribute('data-cat');
        j.forEach((A) => {
          const H = A.getAttribute('data-title'),
            L = A.getAttribute('data-desc'),
            z = A.getAttribute('data-cat');
          (H.includes(T) || L.includes(T)) && (R === 'all' || z === R)
            ? (A.style.display = 'flex')
            : (A.style.display = 'none');
        });
      };
    u && u.addEventListener('input', D);
    const B = document.querySelectorAll('.category-tab');
    (B.forEach((T) => {
      T.addEventListener('click', () => {
        (B.forEach((R) => R.classList.remove('active')), T.classList.add('active'), D());
      });
    }),
      document.querySelectorAll('.faq-question').forEach((T) => {
        T.addEventListener('click', () => {
          const R = T.parentElement,
            A = R.classList.contains('active');
          (document.querySelectorAll('.faq-item').forEach((H) => H.classList.remove('active')),
      ...
      Ie(
        Object.assign({
          './tools/add-blank-page.js': () =>
            _(() => import('./add-blank-page-jbn05Bm-.js'), __vite__mapDeps([0, 1])),
          './tools/add-page-numbers.js': () =>
            _(() => import('./add-page-numbers-Bi9rF5EA.js'), __vite__mapDeps([2, 1])),
          './tools/compress.js': () =>
            _(() => import('./compress-CHJMIDnR.js'), __vite__mapDeps([3, 1])),
          './tools/crop-resize.js': () =>
            _(() => import('./crop-resize-rWqYeJSS.js'), __vite__mapDeps([4, 1])),
          './tools/delete-pages.js': () =>
            _(() => import('./delete-pages-CfKRV-MV.js'), __vite__mapDeps([5, 1])),
          './tools/extract-pages.js': () =>
            _(() => import('./extract-pages-CaGcRIwX.js'), __vite__mapDeps([6, 1])),
          './tools/image-to-pdf.js': () =>
            _(() => import('./image-to-pdf-qQiqSj9d.js'), __vite__mapDeps([7, 1])),
          './tools/merge.js': () => _(() => import('./merge-CJI2hZOD.js'), __vite__mapDeps([8, 1])),
          './tools/pdf-to-image.js': () =>
            _(() => import('./pdf-to-image-YOMo1AEe.js'), __vite__mapDeps([9, 1])),
          './tools/protect.js': () =>
            _(() => import('./protect-YUsn3W4B.js'), __vite__mapDeps([10, 1])),
          './tools/reorder.js': () =>
            _(() => import('./reorder-DUmPk8Sm.js'), __vite__mapDeps([11, 1])),
          './tools/rotate.js': () =>
            _(() => import('./rotate-CtuFxYM0.js'), __vite__mapDeps([12, 1])),
          './tools/split.js': () =>
            _(() => import('./split-Bryzo1BY.js'), __vite__mapDeps([13, 1])),
          './tools/unlock.js': () =>
            _(() => import('./unlock-IOEueewQ.js'), __vite__mapDeps([14, 1])),
          './tools/watermark.js': () =>
            _(() => import('./watermark-Dy4Vprva.js'), __vite__mapDeps([15, 1])),
        }),
        `./tools/${r}.js`,
        3,
      ).catch((p) => {
        (console.error(`[PDFMinty] Failed to load tool script: ./tools/${r}.js`, p),
          (s.innerHTML = `
                    <div style="text-align: center; padding: 4rem 2rem; color: var(--text);">
                        ...
                        <p style="color: var(--muted); margin-bottom: 2rem;">We couldn't load the "${r}" tool. This might be due to a slow connection or the file missing on the server.</p>
  ...
  function d() {
    ...
    ((s.style.opacity = '0'),
      ...
      setTimeout(() => {
        ((s.innerHTML = ''),
          r ? (w.some((u) => u.id === r) ? v(r) : (window.location.hash = '')) : a(s),
  ...
  (g &&
    ...
    g.addEventListener('click', () => {
      ...
      const s = document.body.classList.contains('light-mode'),
        p = s ? 'light' : 'dark';
      (localStorage.setItem('theme', p),
        ...
        typeof Z == 'function' &&
          Z({
            ...
            spread: 50,
            origin: { y: 0.8 },
            colors: s ? ['#6366f1', '#f59e0b'] : ['#6366f1', '#0ea5e9'],
          }));
    })),
    ...
    (window.renderPdfThumbnail = async function (r, s) {
      try {
        typeof pdfjsLib > 'u' &&
        ...
        const p = await r.arrayBuffer(),
          j = await (await pdfjsLib.getDocument({ data: p }).promise).getPage(1),
          D = j.getViewport({ scale: 1 }),
          B = document.createElement('canvas'),
          E = B.getContext('2d');
        ((B.width = D.width),
          (B.height = D.height),
          await j.render({ canvasContext: E, viewport: D }).promise,
          (s.src = B.toDataURL()));
      } catch (p) {
  ...
  function y(r, s) {
    ...
    const u = s.includes('success'),
      P = u ? '✅' : '⚠️';
    ((p.innerHTML = `<span>${P}</span> <span>${r}</span>`),
      (p.className = 'toast'),
  ...
  ((window.showProgress = function (r) {
    let s = document.getElementById('modern-progress-overlay');
    s ||
      ((s = document.createElement('div')),
      (s.id = 'modern-progress-overlay'),
      (s.innerHTML = `
      ...
      requestAnimationFrame(() => {
        ((s.style.opacity = '1'), (s.style.backdropFilter = 'blur(10px)'));
      }));
    ...
    (p && (p.style.width = `${Math.min(100, Math.max(0, r))}%`),
      r % 25 === 0 && u && (u.textContent = F[Math.floor(Math.random() * F.length)]),
      r >= 100 &&
        (u && (u.textContent = 'Done! 🎉'),
        setTimeout(() => {
          s &&
            ((s.style.opacity = '0'),
            (s.style.backdropFilter = 'blur(0px)'),
    ...
    (window.downloadFile = function (r, s) {
    ...
    (window.initDropZone = function (r, s, p, u = '') {
      const P = document.getElementById(r),
        j = document.getElementById(s);
      if (!P || !j) return;
      (u && (j.accept = u), P.classList.add('drop-zone-enhanced'));
      ...
      ((D.className = 'drop-overlay'),
        ...
        `),
        P.appendChild(D));
      const B = D.querySelector('.drop-icon-large'),
        E = D.querySelector('.drop-text-large'),
        T = D.querySelector('.drop-progress-container'),
        R = D.querySelector('.drop-progress-bar'),
        A = (L, z, U = !1) => {
          ((B.textContent = L),
            (E.textContent = z),
            U
              ? (T.classList.remove('hidden'), (B.style.animation = 'none'))
              : (T.classList.add('hidden'), (B.style.animation = '')));
        };
      (P.addEventListener('click', (L) => {
        L.target !== j && j.click();
      }),
        P.addEventListener('dragover', (L) => {
          (L.preventDefault(), P.classList.add('drag-active'), A('📥', 'Release to add files'));
        }),
        P.addEventListener('dragleave', (L) => {
          (L.preventDefault(), P.contains(L.relatedTarget) || P.classList.remove('drag-active'));
        }),
        P.addEventListener('drop', async (L) => {
          (L.preventDefault(),
            P.classList.remove('drag-active'),
            L.dataTransfer.files.length > 0 && (await H(L.dataTransfer.files)));
        }),
        j.addEventListener('change', async (L) => {
          L.target.files.length > 0 && (await H(L.target.files));
        }));
      async function H(L) {
        (D.classList.add('active'), A('⏳', `Processing ${L.length} file(s)...`, !0));
        for (let z = 0; z <= 100; z += 20)
          ((R.style.width = `${z}%`), await new Promise((U) => setTimeout(U, 30)));
        ((D.innerHTML = `
...
window.initPdfWorker = function () {
  $ ||
    ...
    ($.onmessage = function (w) {
      const { id: a, status: v, result: d, error: i, progress: g } = w.data;
      if (v === 'progress') {
        N[a] && N[a].onProgress && N[a].onProgress(g);
        return;
      }
      N[a] && (v === 'success' ? N[a].resolve(d) : N[a].reject(new Error(i)), delete N[a]);
    }),
    ($.onerror = function (w) {
      console.error('Worker error:', w);
      for (let a in N) (N[a].reject(new Error('Worker crashed')), delete N[a]);
    }));
};
window.runPdfWorkerTask = function (w, a, v = [], d = null) {
  return (
    window.initPdfWorker(),
    new Promise((i, g) => {
      const y = ++Te;
      ((N[y] = { resolve: i, reject: g, onProgress: d }),
        (a.id = y),
        $.postMessage({ id: y, task: w, payload: a }, v));
    })
  );
};
window.pdfDB = {
  ...
  init() {
    return new Promise((w, a) => {
      ...
      ((v.onerror = (d) => a('IndexedDB error: ' + d.target.error)),
        (v.onsuccess = (d) => w(d.target.result)),
        (v.onupgradeneeded = (d) => {
  ...
  async saveFile(w, a) {
    ...
    return new Promise((d, i) => {
      const F = v.transaction(this.storeName, 'readwrite').objectStore(this.storeName).put(a, w);
      ((F.onsuccess = () => d(w)), (F.onerror = () => i(F.error)));
    });
  },
  async getFile(w) {
    const a = await this.init();
    return new Promise((v, d) => {
      const y = a.transaction(this.storeName, 'readonly').objectStore(this.storeName).get(w);
  ...
  async deleteFile(w) {
    const a = await this.init();
    return new Promise((v, d) => {
      const y = a.transaction(this.storeName, 'readwrite').objectStore(this.storeName).delete(w);
  ...
  async clearAll() {
    ...
    return new Promise((a, v) => {
      const g = w.transaction(this.storeName, 'readwrite').objectStore(this.storeName).clear();
      ((g.onsuccess = () => a()), (g.onerror = () => v(g.error)));
    });
  },
};
'serviceWorker' in navigator &&
  navigator.serviceWorker.register('/sw.js').catch((w) => console.error('SW reg failed', w));
window.addEventListener('load', () => {
  window.pdfDB && window.pdfDB.clearAll().catch((w) => {});
});
window.addEventListener('beforeunload', () => {
  window.pdfDB && window.pdfDB.clearAll().catch((w) => {});
});
window.callGeminiAPI = async function (w, a = '', v = []) {
  try {
    const d = await fetch('/.netlify/functions/gemini-proxy', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ prompt: w, context: a, history: v }),
      }),
      i = await d.json();
