...
function ToolPageLoader({ page }: { page: string }) {
...
function ClassicLazyPDFPage({ pageNumber, pdfDocument, scale = 1.0 }: ClassicLazyPDFPageProps & { pageNumber: number }) {
...
export function LazyPDFPage(props: DualLazyPDFPageProps) {
  ...
  if (props.page) {
    return <ToolPageLoader page={props.page} />;
  }
