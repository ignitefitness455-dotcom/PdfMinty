...
export function createUI(container, { locale = 'en', onProcess, onCancel }) {
  container.innerHTML = `
    <div class="tool-container">
      ...
      <div class="tool-header">
        <h1>Compress PDF</h1>
        <p>Reduce file size by converting pages to optimized JPEG images</p>
      </div>
      ...
      <div id="workspace" class="workspace hidden">
        ...
        <div class="settings-panel" style="grid-template-columns: 1fr; border: 1px solid rgba(255,255,255,0.05); border-radius: 8px;">
          <div class="setting-group full-width" style="margin-bottom: 1.5rem;">
            ...
            <select id="compressionLevel" class="select-input" style="width: 100%; border: 1px solid rgba(255,255,255,0.1); border-radius: 6px;">
  ...
  container.querySelector('#btn-apply').addEventListener('click', () => {
    const level = container.querySelector('#compressionLevel').value;
    onProcess(fileBytes, {
      level,
