...
export function createUI(container, { locale = 'en', onProcess, onCancel }) {
  container.innerHTML = `
    <div class="tool-container">
      ...
      <div class="tool-header">
        <h1>Extract Pages</h1>
        <p>Extract specific pages from your PDF as a brand new document</p>
      </div>
  ...
  container.querySelector('#btn-apply').addEventListener('click', () => {
    const rangesText = container.querySelector('#extract-ranges').value.trim();
    if (!rangesText) {
