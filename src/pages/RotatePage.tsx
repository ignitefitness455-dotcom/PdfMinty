...
export const RotatePage: React.FC = () => {
  ...
  const handleRotate = async () => {
    ...
    try {
      const rotatedBytes = await rotatePdf(selectedFile, degrees);
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto" id="rotate_page_container">
      <SEO 
        title="Rotate PDF — Free Offline PDF Rotator" 
        description="Rotate PDF pages 90, 180 or 270 degrees offline instantly inside your browser. No server overhead, fast, safe, and confidential."
      />
      ...
      <div className="space-y-2">
        <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">Rotate PDF Pages</h1>
        <p className="text-slate-500 text-sm">Correct orientation or re-align horizontally skewed page plates offline instantly.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-4">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            {!selectedFile ? (
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between" id="loaded_rotate_file">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between h-fit space-y-6">
          <div className="space-y-4">
            <h3 className="font-bold text-slate-900 border-b border-slate-100 pb-2">Rotation Angle</h3>
            ...
            <p className="text-xs text-slate-400">Clockwise rotation applied unconditionally across all page grids.</p>
          </div>
