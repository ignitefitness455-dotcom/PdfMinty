...
import { getFriendlyErrorMessage } from "../core/utils";
            ...
            <div className="space-y-6">
              ...
              {selectedFile && !loading && (
                <div className="space-y-6 animate-fadein text-left">
                  ...
                  {isEncryptedPDF === true ? (
                    <div className="bg-amber-500/5 dark:bg-amber-950/10 border border-amber-500/20 rounded-2xl p-4.5 space-y-3.5">
                      ...
                      <p className="text-[11px] text-slate-550 dark:text-slate-450 leading-relaxed font-semibold border-t border-amber-505/10 dark:border-amber-850/40 pt-3">
                        🙋 <strong>How Decryption Works</strong>: For your absolute privacy, standard browser-based applications cannot capture or bypass OS-sandboxed document password decoders. Instead, follow the fast, native visual guide on the right menu!
                      </p>
                    </div>
