    ...
    <div className="my-24 relative z-20 -mx-4 px-6 py-20 bg-surface-container-low/40 border-y border-border-muted rounded-[40px]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            id="why-card-privacy"
            className="bg-surface-container-lowest border border-border-muted p-6 sm:p-8 rounded-3xl shadow-lg text-center flex flex-col items-center hover:border-security-green transition-all duration-300"
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">Privacy First</h3>
          ...
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">No Account Required</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed font-normal">
          ...
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">Completely Free</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed font-normal">
          ...
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">{toolsCount} Tools</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed font-normal">
          ...
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">Works Offline</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed font-normal">
          ...
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-primary mb-2.5">Instant Execution</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed font-normal">
